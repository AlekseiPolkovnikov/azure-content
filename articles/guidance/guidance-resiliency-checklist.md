...
- **Perform fault-injection testing for your application.** Your application can fail for many different reasons, such as certificate expirations, exhaustion of system resources in a VM, or storage failures. Test your application in an environment as close as possible to production by either simulating or triggering realistic failure conditions. Delete certificates, artificially consume system resources, bring down a storage connection. Verify your application's ability to recover from all possible types of faults, alone and in combination. Check the failures are not propagating or cascading through your system.
